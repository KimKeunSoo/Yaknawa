...
class Join_us extends PureComponent {
  ...
  componentDidMount() {
    //백엔드 서버와 비동기 요청
    fetch(`${this.url}/joinus`).then((res) => res.json());
            ...
            <Row>
              ...
              <Col lg={8}>
                ...
                <div className="body-footer">
                  ...
                  <Link className="addi-alert">이용약관</Link>,
                  <Link className="addi-alert">개인정보 수집 및 이용</Link>,
                  <Link className="addi-alert">개인정보 제공</Link> 내용을 확인
                  하였으며 <strong>동의합니다.</strong>
                </div>
