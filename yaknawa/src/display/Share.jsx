            ...
            <Form ref={form}>
              <Grid container>
                ...
                <Grid item lg={8}>
                  <div className="form-control">
                    <label className="size-big position-left form-label">
                      약국이름<sup>*</sup>
                    </label>
                    <TextField
                      error={ispharmacy ? false : true}
                      helperText={
                        ispharmacy ? "" : "약국이름이 입력되지 않았습니다"
                      }
              ...
              <div className="position-center">
                <Button
                  variant="contained"
                  color="primary"
                  className="share-btn right-space-lg"
                  size="lg"
